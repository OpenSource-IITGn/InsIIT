            ...
            child: Column(
              ...
              children: <Widget>[
                Container(
                  ...
                  child: FlatButton(
                    onPressed: () => Navigator.pushNamed(context, '/RoomBooking'),
              ...
              Container(
                  width: MediaQuery.of(context).size.width * 0.6,
                  child: FlatButton(
                    onPressed: () => Navigator.pushNamed(context, '/importantcontacts'),
                    shape: RoundedRectangleBorder(
                          borderRadius: new BorderRadius.circular(40.0),
                          side: BorderSide(
                            color: Colors.black12,
              ...
              Container(
                  width: MediaQuery.of(context).size.width * 0.6,
                  child: FlatButton(
                    onPressed: () => Navigator.pushNamed(context, '/Quicklinks'),
                    shape: RoundedRectangleBorder(
                          borderRadius: new BorderRadius.circular(40.0),
                          side: BorderSide(
                            color: Colors.black12,
